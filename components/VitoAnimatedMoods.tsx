...
type VitoEmoteConfig = Record<"happy" | "sad", VitoPartsConfig>;
...
const vitoEmoteConfig: VitoEmoteConfig = {
  happy: {
    ...
    LeftEyeExtraReflection: { opacity: 0 },
    RightEyeExtraReflection: { opacity: 0 },
...
export function VitoAnimatedMoods() {
    ...
    <>
      ...
      <Svg width={225} height={202} viewBox="0 0 225 202" fill="none">
        ...
        <AnimatedEllipse
          ...
          fill="white"
          stroke={debugStrokeColor}
          // hardcoded cx,cy because we know eyelids dont change anyway
